...
evaluate the variable `(default-value \\='magit-wip-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='magit-wip-after-apply-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='magit-wip-before-change-mode)'.
