;;; mini-modeline-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Mini-Modeline mode' mode.  If the prefix argument is positive, enable
...
evaluate the variable `(default-value \\='mini-modeline-mode)'.
