...
evaluate the variable `(default-value \\='vertico-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='vertico-buffer-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='vertico-flat-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='vertico-grid-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='vertico-indexed-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='vertico-mouse-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='vertico-multiform-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='vertico-reverse-mode)'.
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `(default-value \\='vertico-unobtrusive-mode)'.
