...
* Emacs
This is my configuration for Emacs 29+ on macOS. My setup is mostly based around =org-mode= and =evil-mode=; I use Emacs for Org-mode, but often use Vim for programming, and this keeps them interchangeable.
