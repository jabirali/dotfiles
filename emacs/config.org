...
** Packages
The =package.el= package manager and =use-package= configuration macro both come with Emacs. We just need to flip some switches to get native compilation and community repos working as expected.
