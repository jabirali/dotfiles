...
(after! magit
  ...
  (pretty-magit "Feat"  ? (:foreground "#cc241d" :height 1.0))
  (pretty-magit "Add"   ? (:foreground "#d79921" :height 1.0))
  (pretty-magit "Fix"   ? (:foreground "#d79921" :height 1.0))
  (pretty-magit "Clean" ? (:foreground "#689d6a" :height 1.0))
  (pretty-magit "Docs"  ? (:foreground "#458588" :height 1.0))
