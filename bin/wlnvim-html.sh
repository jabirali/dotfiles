...
wl-paste -t text/html -p | pandoc -f html --atx-headers --reference-links \
	-t markdown-raw_html-native_divs-native_spans-fenced_divs-bracketed_spans-header_attributes > $tmp
