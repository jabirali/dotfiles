# Generated by Powerlevel10k configuration wizard on 2021-11-12 at 09:17 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%7F╰─%{\e[6 q%}'
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_CONTENT_EXPANSIONN='${$((my_git_formatter(0)))+${my_git_format}}'
